    ...
    this.unsubscribe = firebase.auth().onAuthStateChanged((user) => {
      if (user) {
        if (authFlag) {
          ...
          FCM.getInitialNotification().then((notif) => {
            ...
            if (notif.actionId && this.props.auth.type == "em" && notif.channel) {
              if (notif.actionId == "1") {
                this.props.navigation.navigate("requestDetail", {
                  ...
                  departmentId: notif.itemData.departmentId,
                  title: notif.itemData.title,
                });
            ...
            if (notif.actionId && this.props.auth.type == "re" && notif.channel) {
              if (notif.actionId == "1") {
                ...
                this.props.navigation.navigate("newsDetail", {
                  item: {
                    id: notif.itemData.linkid,
                    towerId: notif.itemData.towerId,
                    towerName: notif.itemData.towerName,
                  },
                  type: 1,
                });
              } else if (notif.actionId == "3") {
                this.props.navigation.navigate("serviceBasicDetailResident", {
                  item: notif.itemData,
                  type: notif.itemData.typeId,
                });
              } else if (notif.actionId == "4") {
                this.props.navigation.navigate("serviceExtensionDetailResident", {
                  id: notif.itemData.id,
                });
          ...
          if (
            this.props.navigation.state.params.type == "em" ||
            ...
            this.props.navigation.state.params.type == "re" ||
            (this.props.navigation.state.params.type == undefined &&
              this.props.auth.type == "re")
          ) {
            console.log("re như");
      ...
      >
        <Image
          ...
          style={{
            ...
            marginTop: Screen.height / 2 - responsive.h(250),
            resizeMode: "contain",
          }}
        />
