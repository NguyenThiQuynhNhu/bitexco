...
class DashboardChecklist extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        const { rowPerPage, isRefreshing, initList, errorResponse, refreshDataHandle } = this.props;
            ...
            <View style={styles.container}>
                <NavBar
                    ...
                    body={<View style={{ justifyContent: 'center' }}>
                        <Text style={{ color: '#fff', alignSelf: 'center', fontSize: fontSize.medium, fontWeight: 'bold' }}>{ this.props.navigation.state.params.towerName.toLocaleUpperCase() } > CHECKLIST</Text>
                    </View>
                    }
...
export default connect(mapStateToProps, mapActionToState)(DashboardChecklist);
