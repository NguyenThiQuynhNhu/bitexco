...
//
import { loadDataHandle, resetStateByKey, refreshDataHandle } from '../../../resident/actions/survey';
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                >
                    <View style={{ borderRadius: 45, height: 40, width: 40, backgroundColor: "#fff200", justifyContent: 'center', alignItems: 'center', marginLeft: 10 }}>
                    ...
                    <View style={{ flex: 1, justifyContent: 'space-between', margin: 10 }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 5 }}>
                            <Text style={{
                                ...
                                textAlign: "left",
                                color: "#6f6f6f"
                            }}>{moment(dateFr).format('DD/MM/YYYY HH:mm')} - {moment(dateTo).format('DD/MM/YYYY HH:mm')}</Text>
                        </View>
                    </View>
...
class SurveyStatisticScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
    ...
    renderItem = ({ item }) => {
        return <ListItem item={item} onPress={() => this.props.navigation.navigate('surveyChartReport', item)} />
    }
    _renderContent() {
        ...
        return (
            <View style={styles.container}>
                <NavBar
                    ...
                    }} numberOfLines={2} lineBreakMode="tail">Danh sách phiếu</Text>}
                    rightView={
                        <TouchableOpacity
                            style={{ padding: 10 }}>
                            <MyIcon name="reply" color={colors.appTheme} size={20} />
                        </TouchableOpacity>
                    }
                />
                {this._renderContent()}
...
export default connect(mapStateToProps, mapActionToProps)(SurveyStatisticScreen);