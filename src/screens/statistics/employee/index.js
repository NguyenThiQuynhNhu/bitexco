...
class GroupStatisticsScreen extends React.Component {
    ...
    componentDidMount() {
        this.props.getEmployeeByDepartment({ towerId: this.props.towerId, departmentId: 0 });
        this.loadDataHandle()
    }
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ backgroundColor: '#fff' }}>
                        <View style={{ flexDirection: 'row', paddingVertical: 10 }}>
                            <FilterType value={employeeSelected ? employeeSelected.name : 'Chọn nhân viên'} onPress={() => this.setState({ showModalPicker: true })} />
                    ...
                    {this.props.employeeData &&
                        <ModalPicker
                            ...
                            selectedValue={0}
                            onValueChange={(employeeSelected) => this.setState({ showModalPicker: false, employeeSelected }, () => { this.props.refreshDataHandle() })}
    ...
    loadDataHandle() {
        ...
        const { startDate, endDate, typeTime, employeeSelected } = this.state;
        getGeneralReport({
            towerId,
            dateFrom: startDate,
            dateTo: endDate,
            typeTime,
            employeeId: employeeSelected ? employeeSelected.id : 0
...
const mapStateToProps = (state) => ({
    ...
    employeeData: state.statistics.listEmployee
