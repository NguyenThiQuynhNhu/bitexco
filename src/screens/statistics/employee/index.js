...
class GroupStatisticsScreen extends React.Component {
  ...
  componentDidMount() {
    this.props.getEmployeeByDepartment({
      ...
      <View style={{ backgroundColor: "#eeeeee", flex: 1, marginBottom: responsive.h(10),}}>
        <NavBar
          ...
          body={
            ...
            >
              {Strings.statistical.employeeStatistics}
            </Text>
          }
          //   rightView={
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ backgroundColor: "#fff" }}>
            <View style={{ flexDirection: "row", paddingVertical: responsive.h(10) }}>
              <FilterType
                value={
                  employeeSelected ? employeeSelected.name : `${Strings.common.choose} ${Strings.common.employee}`
                }
          ...
          {this.props.employeeData && (
            <ModalPicker
              ...
              selectedValue={0}
              onValueChange={(employeeSelected) =>
                this.setState(
                  { showModalPicker: false, employeeSelected },
                  () => {
                    this.props.refreshDataHandle();
                  }
                )
