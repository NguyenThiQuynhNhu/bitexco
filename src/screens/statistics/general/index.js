    ...
    renderDataLine() {
        ...
        if (data) {
            ...
            if (dataLine.length == 0) {
                return <TouchableOpacity onPress={() => { this.props.refreshDataHandle() }}>
                    <Text style={{ textAlign: 'center', fontSize: fontsize.small }}>Không có dữ liệu</Text>
                </TouchableOpacity>
            } else {
            ...
            return (
                ...
                >
                    <Text style={{ textAlign: 'center', fontSize: fontsize.small }}>Có lỗi xảy ra</Text>
                </TouchableOpacity>
            )
        }
    }
            ...
            <View style={{ backgroundColor: '#eeeeee', flex: 1, marginBottom: 10 }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <ModalPicker
                        ...
                        selectedValue={0}
                        onValueChange={(typeTime) => this.setState({ showModalPicker: false, typeTime }, () => { this.props.refreshDataHandle() })}
                        data={DataFilter}
...
export default connect(mapStateToProps, mapActionToProps)(GeneralStatisticsScreen);
