...
import {
  ...
  onChangeText,
  onClearText,
} from "../../../actions/notification_bangiao";
  ...
  renderItem = ({ item }) => {
    ...
    return (
      <ListItem
        item={item}
        onPress={() => {
          this.props.navigation.navigate("Notification_Bangiao_Detail", {
            item,
            type: 1,
          });
          // if (actionId == 2) {
        ...
        {isShowSearch ? (
          ...
          <NavBar
            ...
            body={
              ...
              >
                {(item ? item.name : "thông báo").toLocaleUpperCase()}
              </Text>
            }
            rightView={
              <TouchableOpacity
                ...
                style={{ padding: 10 }}
              >
                <MyIcon size={20} name="search" color={colors.appTheme} />
              </TouchableOpacity>
            }
          />
        )}
