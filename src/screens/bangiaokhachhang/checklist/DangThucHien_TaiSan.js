...
//data
import { loadDataHandle, refreshDataHandle, resetStateByKey, progressHandle, HandoverHandle, UploadImages, DeleteImages } from '../../../actions/checklist_dangthuchien_taisan_khachhang'
...
class DangThucHien_TaiSan extends Component {
    ...
    item_status_click() {
        ...
        this.props.HandOverStatus(parram)
            .then((data) => {
                //console.log(data)
                var list = data.map(i => {
...
const mapStateToProps = (state) => ({
    ...
    isApplySearchKey: state.checklist_dangthuchien_taisan_khachhang.isApplySearchKey,
