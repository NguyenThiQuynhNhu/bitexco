...
import { loadDataHandle, resetStateByKey, updateRequestHandle } from '../../../actions/servicesExtensionDetail';
        ...
        return (
            <View style={{
                ...
                <View style={{ flexDirection: 'row' }}>
                    <ImageProgress source={{ uri: `${avatarUrl || default_image}` }} circle={true}
                        style={{
                            height: 32,
                            width: 32
                        }} />
                    ...
                    <View
                        ...
                        <View style={{ flex: 1, alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }}>
                            ...
                            <View
                                ...
                                <Text style={{ margin: 5, marginHorizontal: 10, fontFamily: "Inter-Regular", fontSize: fontsize.micro, color: converStatusToColorService(statusId) }}>{statusName}</Text>
                            </View>
                        </View>
            ...
            <TouchableOpacity
                onPress={() => {
                    this.setState({ showAction: false }, () => {
                        switch (moduleCode) {
                            //Hoàn thành
                            case 'hoan_thanh': return this.setState({
                                isShowModal: true,
                                moduleId,
                                statusId: 3,
                            ...
                            case 'doi_nhan_vien': return this.props.navigation.navigate('serviceExtensionDetailAssignEmployee', { title: moduleName });
                            //Đổi Trạng Thái Yêu Cầu
                            case 'doi_trang_thai': return this.props.navigation.navigate('serviceExtensionDetailUpdateStatus');
                    ...
                    <View style={{ flex: 1, borderTopRightRadius: 20  }}>
                            ...
                            <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'space-between', marginHorizontal: 10 }}>
                                ...
                                >
                                    ...
                                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <View
                                            style={{
                                                borderRadius: 16, backgroundColor: converStatusToColorService(statusId), paddingHorizontal: 20, alignItems: 'center', marginVertical: 5, justifyContent: 'center', paddingVertical: 5
                                            }}>
                                            < Text style={{
                        ...
                        <View style={{
                            ...
                            <View style={{ flexDirection: 'row', marginBottom: 10, paddingHorizontal: 10, justifyContent: 'space-between' }}>
                                <Text style={styles.textTitle}>{Strings.serviceExtension.dateCreate}</Text>
                                <Text style={{ ...styles.textInfo, marginLeft: 5 }}>{moment(dateCreate).format('DD/MM/YYYY HH:mm')}</Text>
                            </View>

                            <View style={{ flexDirection: 'row', marginBottom: 10, paddingHorizontal: 10, justifyContent: 'space-between' }}>
                                <Text style={styles.textTitle}>{Strings.serviceExtension.dateBook}</Text>
                                <Text style={{ ...styles.textInfo, marginLeft: 5 }}>{moment(dateBook).format('DD/MM/YYYY HH:mm')}</Text>
                            </View>

                            <View style={{ flexDirection: 'row', marginBottom: 10, paddingHorizontal: 10, justifyContent: 'space-between' }}>
                                <Text style={styles.textTitle}>{Strings.serviceExtension.price}</Text>
