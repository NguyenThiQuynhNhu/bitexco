...
import {
    refreshDataHandle as refreshDataHandleListElectric
} from '../../../actions/water'
// create a component
class CreateScreen extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            waterRequest: props.navigation.state.params.data.indexId > 0 ?
                {
                    ...
                    peoplePromotion: props.navigation.state.params.data.peoplePromotion,
                    m3PerPeople: props.navigation.state.params.data.m3PerPeople,
                    rateFeeEnviroment: props.navigation.state.params.data.rateFeeEnviroment,
                    ...
                    linkUrl: (!props.navigation.state.params.data.linkUrl || props.navigation.state.params.data.linkUrl == null) ? '' : props.navigation.state.params.data.linkUrl
                    ...
                    this.state.waterRequest.linkUrl != '' ?
                        <View>
                            ...
                            /> */}
                                ...
                                >
                                    <Image source={{ uri: this.state.waterRequest.linkUrl }} style={{ width: 90, height: 120, zIndex: 0, borderRadius: 8 }} />
                                </Lightbox>
                            </View>
                        </View>
                        :
    ...
    renderContent() {
        ...
        if (data) {
            ...
            const { indexId } = data
            return (
                <KeyboardAwareScrollView style={{ borderTopRightRadius: 20, marginTop: 5, marginHorizontal: 10 }}>
                    <View style={styles.container}>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(indexNew) => { this.setState({ waterRequest: { ...this.state.waterRequest, indexNew } }) }}
                                />
                            </View>
                            ...
                            {this.state.images.length > 0 ?
                                <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                                    ...
                                    {this.state.images.map((eachImage, y) => {
                                        return (
                                            <View key={y} style={{ justifyContent: 'center', alignItems: 'center' }}>
                                                <Lightbox
                                                    style={{ marginTop: 10, marginRight: 10, borderRadius: 5, backgroundColor: '#eeeeee' }}
                                                    activeProps={{
                                                        style: styles.imageActive
                            ...
                            <View style={{
                                ...
                                <TextInput
                                    ...
                                    underlineColorAndroid='transparent'
                                    onChangeText={(peoplePromotion) => { this.setState({ waterRequest: { ...this.state.waterRequest, peoplePromotion } }) }}
                                />
                            </View>
                            <View style={{
                                flexDirection: 'row',
                                ...
                                <TextInput
                                    ...
                                    underlineColorAndroid='transparent'
                                    onChangeText={(m3PerPeople) => { this.setState({ waterRequest: { ...this.state.waterRequest, m3PerPeople } }) }}
                                />
                                <Text style={{
                                    justifyContent: 'flex-end', marginLeft: 5, fontSize: fontsize.small, color: '#282828',
                                    fontFamily: "Inter-SemiBold",
                                }}>m</Text>
                                <Text style={{
                                    justifyContent: 'flex-end', marginTop: -5, fontSize: fontsize.small, color: '#282828',
                                    fontFamily: "Inter-SemiBold",
                                }}>3</Text>
                            </View>
                            <View style={{
                                ...
                                <TextInput
                                    ...
                                    underlineColorAndroid='transparent'
                                    onChangeText={(rateFeeEnviroment) => { this.setState({ waterRequest: { ...this.state.waterRequest, rateFeeEnviroment: Number(rateFeeEnviroment)/100 } }) }}
                                />
                            ...
                            <View style={{
                                ...
                                <TextInput
                                    ...
                                    underlineColorAndroid='transparent'
                                    onChangeText={(rateFeeVAT) => { this.setState({ waterRequest: { ...this.state.waterRequest, rateFeeVAT: Number(rateFeeVAT)/100 } }) }}
                                />
                                <Text style={{ justifyContent: 'flex-end', marginLeft: 5, fontSize: fontsize.small, fontFamily: "Inter-SemiBold", color: '#282828' }}>%</Text>
                            </View>
                            <View style={{
                                ...
                                <TextInput
                                    ...
                                    placeholderTextColor="#a0a0a0"
                                    value={description}
                                    onChangeText={(description) => { this.setState({ waterRequest: { ...this.state.waterRequest, description } }) }}
                                />
                            </View>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                justifyContent: 'flex-end', fontSize: fontsize.small,
                                fontFamily: "Inter-SemiBold",
                                fontWeight: "600",
                                color: "#f53b3b"
                            }}>{indexOld}</Text>
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                justifyContent: 'flex-end', fontSize: fontsize.small, fontFamily: "Inter-SemiBold",
                                fontWeight: "600",
                                color: "#f53b3b"
                            }}>{Number(indexNew) > 0 ? (indexNew - indexOld) : ''}</Text>
                        </View>
                        ...
                        <TouchableOpacity
                            ...
                            <Text style={{
                                justifyContent: 'flex-end', fontSize: fontsize.small, fontFamily: "Inter-Medium",
                                fontSize: 14,
                                fontWeight: "500",
                                color: "#a0a0a0"
                            }}>{dateFrom === null ? "" : moment(dateFrom).format('DD/MM/YYYY')} - {dateTo === null ? "" : moment(dateTo).format('DD/MM/YYYY')}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => this.setState({ isShowPopupCustomDateThanhToan: true })} style={{
                                flexDirection: 'row',
                                alignItems: 'center',
                                justifyContent: 'space-between',
                                paddingVertical: 15,
                            ...
                            <Text style={{
                                ...
                                fontWeight: "500",
                                color: "#a0a0a0"
                            }}>{datePayment === null ? "" : moment(datePayment).format('DD/MM/YYYY')}</Text>
                        </TouchableOpacity>
                        {indexId > 0  && <TouchableOpacity
                            onPress={() => this.setState({ isShowPopupCustomDateThongBao: true })}
                            style={{
                                flexDirection: 'row',
                                alignItems: 'center',
                                justifyContent: 'space-between',
                            ...
                            <Text style={{
                                ...
                                fontWeight: "500",
                                color: "#a0a0a0"
                            }}>{dateNotify === null ? "" : moment(dateNotify).format('DD/MM/YYYY')}</Text>
                        </TouchableOpacity>}

                        {
                            indexId > 0 ? <View style={{
                                flexDirection: 'row',
                                alignItems: 'center',
                                justifyContent: 'space-between',
                                paddingVertical: 15,
                                ...
                                <Text style={{
                                    justifyContent: 'flex-end', fontSize: fontsize.small, fontFamily: "Inter-SemiBold",
                                    fontWeight: "600", color: "#f53b3b"
                                }}>{amount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')} <Text style={{
                ...
                >
                    <View style={{ flex: 1, backgroundColor: colors.appOverView, justifyContent: 'center', alignItems: 'center' }}>
                                ...
                                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', borderWidth: 0 }}>
                                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                        ...
                                        <TouchableOpacity onPress={() => this._showDateTimePicker(true)} bordered dark style={{ borderRadius: 0, flex: 1, justifyContent: 'center', alignItems: 'center', marginRight: 5, padding: 10 }}>
                                            <Text style={{ fontSize: fontSize.medium, color: '#111' }}>{moment(this.state.waterRequest.dateFrom).format('DD-MM-YYYY')}</Text>
                                        </TouchableOpacity>
                                        ...
                                        <TouchableOpacity onPress={() => this._showDateTimePicker(false)} bordered dark style={{ borderRadius: 0, flex: 1, padding: 10, justifyContent: 'center', alignItems: 'center' }}>
                                            <Text style={{ fontSize: fontSize.medium, color: '#111' }}>{moment(this.state.waterRequest.dateTo).format('DD-MM-YYYY')}</Text>
                                        </TouchableOpacity>
                                    </View>
                        ...
                        <DateTimePicker
                            ...
                            date={this.state.isStartDate ? new Date(this.state.waterRequest.dateFrom) : new Date(this.state.waterRequest.dateTo)}
                        />
                    </View>
    ...
    _hideDateTimePicker = () => this.setState({ isDateTimePickerVisible: false, isShowPopupCustomDateThanhToan: false, isShowPopupCustomDateThongBao: false });

    _handleDatePicked = (date) => {
        if (this.state.isStartDate) {
            this.setState({ waterRequest: { ...this.state.waterRequest, dateFrom: moment(date).format('YYYY-MM-DD') } });
        } else {
            this.setState({ waterRequest: { ...this.state.waterRequest, dateTo: moment(date).format('YYYY-MM-DD') } });
        }
        this._hideDateTimePicker();
    };
    _handleDatePickedThanhToan = (date) => {
        this.setState({ waterRequest: { ...this.state.waterRequest, datePayment: moment(date).format('YYYY-MM-DD') } });
        this._hideDateTimePicker();
    };
    _handleDatePickedThongBao = (date) => {
        this.setState({ waterRequest: { ...this.state.waterRequest, dateNotify: moment(date).format('YYYY-MM-DD') } });
        this._hideDateTimePicker();
    };
    customTime = () => {
        this.setState({
    ...
    _onSend = async () => {
        ...
        if (Number(indexNew) === NaN) {
            return this.refs.toast.show(`${Strings.message.pleaseType}` + ' Chỉ số mới', DURATION.LENGTH_LONG);
        }
        ...
        const ret = await post('/Water/CanhBao', {
            ...
            rateFeeEnviroment,
            rateFeeVAT,
            imagesInformation: this.state.imagesInformation[0] ? this.state.imagesInformation[0] : {}
        });
        console.log(ret)
    ...
    _onAttachment = () => {
        const options = {
            ...
            permissionDenied: { title: Strings.createRequest.access, text: Strings.createRequest.access2, reTryTitle: Strings.createRequest.retry, okTitle: Strings.createRequest.allow }
        };
...
export default connect(mapStateToProps, mapActionToProps)(CreateScreen);
