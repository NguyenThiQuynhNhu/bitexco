...
import {
  ...
  updateHandle,
  updateStatusHandle,
} from "../../../actions/shiftChangeDetail";
  ...
  renderDetail(rowData, sectionID, rowID) {
    let time =
      this.props.language == "en"
        ? moment(rowData.dateCreate).format("HH:mm:ss - MMMM Do YYYY")
        : moment(rowData.dateCreate).format("HH:mm:ss - DD [tháng] MM, YYYY");
        ...
        <ScrollView>
          <View style={{ flex: 1, paddingHorizontal: 10 }}>
              ...
              >
                <View style={{ width: "45%" }}>
                  ...
                  <Text style={{ textAlign: "right" }}>
                    {employeeName2.toLocaleUpperCase()}
                  </Text>
                  {isReplace === true ? (
                    <Text style={{ fontWeight: "300", textAlign: "right" }}>
                      Làm thay
                    </Text>
                  ) : (
                    <Text style={{ fontWeight: "300", textAlign: "right" }}>
                      Ca {shiftOld2 !== null ? shiftOld2 : ""}
                    </Text>
                  )}
                ...
                >
                  {isReplace === true ? (
                    <Icon name="autorenew" size={15} color={colors.appTheme} />
                  ) : (
                    <Icon
                      name="chevron-right"
                      size={15}
            ...
            >
              ...
              />
              <Text style={{ margin: 10, fontSize: fontsize.medium }}>
                {description}
              </Text>
              <Icon
