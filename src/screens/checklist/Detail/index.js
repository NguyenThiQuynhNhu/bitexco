...
class ChecklistDetailScreen extends Component {
            ...
            case "2":
              this.setState({ ...initState, showAction: false }, () => {
                this.setState(
                  ...
                  () => {
                    this.checkValidateDone()
                      ? this.onSubmitUpdateStatus()
                      : this.refs.toast.show(
                          `Bạn chưa thực hiện xong tất cả công việc. Vui lòng kiểm tra lại, xin ảm ơn.`,
    ...
    return (
      <View style={styles.container}>
        ...
        {this.state.isShowModal && (
          <TouchableOpacity
            onPress={() => {
              this.setState({ isShowModal: false, itemSelected: null });
            }}
            style={{
              height: "100%",
              width: "100%",
                    ...
                    <View style={{ flexDirection: "row", marginTop: 10 }}>
                      ...
                      <TouchableOpacity
                        ...
                        style={{
                          ...
                          justifyContent: "center",
                          alignItems: "center",
                          backgroundColor: !this.checkValidateProposal()
                            ? colors.gray1
                            : colors.appTheme,
                        }}
                      >
              ...
              <View style={{ padding: 10 }}>
                ...
                <View style={{ flexDirection: "row", marginTop: 10 }}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      this.setState({ isShowModalImages: false });
                    }}
                  >
                ...
                >
                  ...
                  <View style={{ padding: 10 }}>
                    ...
                    >
                      ...
                      <Text>
                        {property.id !== 0 ? property.name : "Chưa chọn"}
                      </Text>
                    </TouchableOpacity>
  ...
  choiceLevel() {
    const { data } = this.props;
    if (data.typeSystemId === 1) this.choiceLevel2();
    else if (data.typeSystemId === 2) this.choiceLevel3();
  ...
  choiceLevel2() {
    ...
    this.props.navigation.navigate("propertyList", {
      ...
      propertyName: property3.name,
      typeSystemId: data.typeSystemId,
      onSelected: (value) => {
        this.setState(
          { property: value, category: { id: value.id, name: value.name } },
          () => {
  ...
  choiceLevel3() {
    ...
    this.props.navigation.navigate("propertyList", {
      ...
      onSelected: (value) => {
        this.setState(
          { property: value, property3: { id: value.id, name: value.name } },
          () => {
            const { property } = this.state;
            if (!property.isDone) {
              this.choiceLevel4();
  ...
  onSubmit = () => {
    this.setState(
      { isShowModalItem: false, isShowModalItemIndex: false },
      () => {
        const {
          itemSelected,
          description,
