...
class ChecklistOfflineDetailScreen extends Component {
  ...
  renderContent() {
    ...
    if (data) {
      const { items, checklistTypeId } = data;
        ...
        <View style={{ flex: 1 }}>
          {Devices.isTablet ? (
            checklistTypeId === 3 ? (
              ...
              >
                <View style={{ width: 50 }}>
                  <Text style={{ padding: 10 }}>STT</Text>
                </View>
                ...
                >
                  <Text style={{ padding: 10 }}>Nội dung kiểm tra</Text>
                </View>
                ...
                >
                  <Text style={{ padding: 10 }}>Đơn vị</Text>
                </View>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  <Text style={{ padding: 10 }}>Hình ảnh</Text>
                </View>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  <Text style={{ padding: 10 }}>Chỉ số cũ</Text>
                </View>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  <Text style={{ padding: 10 }}>Chỉ số mới</Text>
                </View>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  <Text style={{ padding: 10 }}>Tiêu thụ</Text>
                </View>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  <Text style={{ padding: 10 }}>Ghi chú</Text>
                </View>
              </View>
            ) : (
              <View
              ...
              >
                ...
                >
                  <Text style={{ padding: 10 }}>Tiêu chuẩn</Text>
                </View>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  <Text style={{ padding: 10 }}>Bình thường</Text>
                </View>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  <Text style={{ padding: 10 }}>Bất thường</Text>
                </View>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  <Text style={{ padding: 10 }}>Nhập/ Chọn</Text>
                </View>
                <View
                  style={{
                    flex: 1,
    ...
    if (checklistTypeId === 3) {
      return (
        <ListItemIndex
          ...
          isOwner={isOwner}
          onPressImage={() => {
            this.setState({ isShowModalImages: true, itemSelected: item });
          }}
          onPress={() => {
            this.setState(
              {
                ...initState,
                itemSelected: item,
                valueInput: item.employeeId > 0 ? item.indexNew : "",
                description: item.employeeId > 0 ? item.description : "",
                imagesEdit:
                  item.employeeId > 0 ? item.images.map((x) => x) : [],
                imagesEditView: item.employeeId > 0 ? item.images : [],
              },
              () => {
                this.showEditIndex();
              }
                ...
                valueInput:
                  item.employeeId > 0
                    ? item.isSelect
                      ...
                      : item.value
                    : item.isSelect
                    ? { id: item.standard, name: item.standard }
                    : "Bình thường",
                description: item.employeeId > 0 ? item.description : "",
                imagesEdit:
                  item.employeeId > 0 ? item.images.map((x) => x) : [],
                ...
                this.setState(
                  {
                    ...
                    description:
                      item.moduleId === 1 ? "Tiếp nhận" : "Hoàn thành",
                  },
                  () => {
  ...
  render() {
    ...
    const rightButton = (
      <TouchableOpacity
        ...
        onPress={() => this.setState({ showAction: true })}
      >
        <MyIcon name="more-vertical" size={20} color="black" />
      </TouchableOpacity>
    );
    return (
        ...
        {this.state.isShowModalItemIndex && (
          ...
          >
            ...
            >
              ...
              >
                <Text style={{ color: "white", fontWeight: "bold" }}>
                  {itemSelected.title.toLocaleUpperCase()}
                </Text>
              </View>
              <View style={{ padding: 10 }}>
                <View
                ...
                >
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({
                        itemSelected: { ...itemSelected, isNormal: true },
                      });
                    }}
                    style={{ flexDirection: "row", alignItems: "center" }}
                  >
                    <Text style={{ marginRight: 5, color: colors.appTheme }}>
                      BÌNH THƯỜNG:
                    </Text>
                    ...
                    <CheckBox
                      onValueChange={() => {
                        this.setState({
                          itemSelected: { ...itemSelected, isNormal: true },
                          valueInput: itemSelected.isSelect ? null : valueInput,
                        });
                      }}
                      value={itemSelected.isNormal}
                    />
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({
                        itemSelected: { ...itemSelected, isNormal: false },
                      });
                    }}
                    style={{ flexDirection: "row", alignItems: "center" }}
                  >
                ...
                >
                  <Text style={{ marginRight: 10, color: colors.appTheme }}>
                    ĐƠN VỊ TÍNH:
                  </Text>
                  <Text>
                    {itemSelected ? itemSelected.unit.toLocaleUpperCase() : ""}
                  </Text>
                </View>
                      ...
                      return (
                        <View key={y}>
                          ...
                          >
                            <Image
                              source={{ uri: imageUrl }}
                              style={{ width: 90, height: 80, zIndex: 0 }}
                            />
                          </Lightbox>

                          <TouchableOpacity
                            onPress={() => {
                              this.deleteImageEdit(imageUrl);
                            }}
                            style={{
                              position: "absolute",
                              top: 0,
