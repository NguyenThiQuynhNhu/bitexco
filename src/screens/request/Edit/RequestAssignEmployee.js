...
class RequestAssignEmployee extends Component {
    ...
    renderContent() {
        ...
        return (
            ...
            <KeyboardAwareScrollView
                ...
                <Lookup
                    fielName={`Phòng ban (*)`}
                    text={depSelected.id != 0 ? depSelected.name : Strings.createRequest.placeholderDepartment}
                ...
                <Lookup
                    ...
                    fielName={`Nhân viên (*)`}
                    text={employeeSelected.id != 0 ? employeeSelected.name : Strings.createRequest.placeholderEmployee}
                    onPress={() => this.props.navigation.navigate('empDictionary', { towerId: user.towerId, departmentId: depSelected.id, onSelected: (employeeSelected) => this.setState({ employeeSelected }) })}
                />
                <Lookup
                    visible={depSelected.id !== 0}
                    fielName={`Nhóm công việc (*)`}
                    text={groupSelected.id != 0 ? groupSelected.name : Strings.createRequest.placeholderGroup}
                ...
                >
                    <Text style={{
                        ...
                        fontStyle: "normal",
                        letterSpacing: 0,
                        textAlign: "left", marginRight: 10, flex: 0.5
                    }}>Cấp độ (*)</Text>
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            letterSpacing: 0,
                            textAlign: "left"
                        }}>{levelSelected.value ? levelSelected.value : Strings.createRequest.placeholderPriority}</Text>
                        <MyIcon
                            size={14}
                        ...
                        {this.props.language == 'en' ?
                            <Text
                                style={{
                                    ...
                                    textAlign: "left",
                                    color: "#282828"
                                }}>{moment(day).format('DD/MM/YYYY')}</Text> :
                            <Text
                                style={{
                                    flex: 1,
                                    fontFamily: "Inter-SemiBold",
        ...
        return (
            ...
            <View style={styles.container}>
                <NavBar leftButton={leftButton} body={<Text style={{
                    ...
                    textAlign: "center",
                    color: "#ffffff"
                }}>{this.props.navigation.state.params.title}</Text>} rightView={rightButton} />
                {this.renderContent()}
    ...
    _onRequest = () => {
        ...
        return this.props.updateRequestHandle({
            ...
            dateProcess: moment(day).format('DD/MM/YYYY') + ' ' + moment(time).format('HH:mm'),
...
export default connect(mapStateToProps, mapActionToProps)(RequestAssignEmployee);
