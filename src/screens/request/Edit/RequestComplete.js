...
class RequestComplete extends Component {
    ...
    render() {
        const {
            data,
            updateRequestHandle } = this.props;
        const {
            images,
            content } = this.state
        const leftButton = (
        ...
        return (
            ...
            <View style={styles.container}>
                <NavBar leftButton={leftButton} body={<Text style={{
                    ...
                    textAlign: "center",
                    color: "#ffffff"
                }}>Báo cáo hoàn thành</Text>} rightView={rightButton} />
                {this.renderContent()}
...
export default connect(mapStateToProps, mapActionToProps)(RequestComplete);
