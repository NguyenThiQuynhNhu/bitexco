            ...
            <View style={styles.container}>
                <NavBar
                    ...
                    body={<View style={{ justifyContent: 'center' }}>
                        <Text style={{ color: '#fff', alignSelf: 'center', fontSize: fontSize.medium, fontWeight: 'bold' }}>DANH SÁCH KIỂM TRA ĐỊNH KỲ</Text>
                        <Text style={{ color: '#fff', alignSelf: 'center', fontSize: fontSize.small, fontWeight: 'bold' }}>{navigation.state.params ? navigation.state.params.title : 'Tất cả'}</Text>
                    </View>
                    }
                ...
                <View>
                    ...
                    >
                        <ButtonFilter value={0} currentValue={this.state.status} onSelectedChange={this._onSelectedChange} style={{ paddingHorizontal: 5 }} />
                        <ButtonFilter value={1} currentValue={this.state.status} onSelectedChange={this._onSelectedChange} />
...
export default connect(mapStateToProps, mapActionToState)(MaintenanceList);
