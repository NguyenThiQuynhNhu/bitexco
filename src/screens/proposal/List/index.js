            ...
            <View style={styles.container}>
                <NavBar
                    ...
                    body={<View style={{ justifyContent: 'center' }}>
                        <Text style={{ color: '#fff', alignSelf: 'center', fontSize: 18, fontWeight: 'bold', fontFamily: "Inter-Bold", }}>Phiếu đề xuất</Text>
                        <Text style={{ color: '#fff', alignSelf: 'center', fontSize: fontSize.small, fontWeight: 'bold', fontFamily: "Inter-Bold" }}>Trạng thái: { converStatusToString(statusId) }</Text>
                    </View>
                    }
