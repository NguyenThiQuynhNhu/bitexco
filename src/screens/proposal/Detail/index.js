...
import { loadDataHandle, resetStateByKey, refreshDataHandle, updateHandle, updateStatusHandle } from '../../../actions/proposalDetail';
...
class ProposalDetailScreen extends Component {
    ...
    renderDetail(rowData, sectionID, rowID) {
        ...
        if (rowData.description !== null && rowData.description !== undefined && rowData.description.length > 0) {
            desc = (
                <View style={{ alignContent: 'space-between', paddingRight: 5, marginTop: 5 }}>
                    <Text style={{
    ...
    renderItemProperty = ({ item, index }) => {
        ...
        return (
            <View>
                <TouchableOpacity>
                    <Text style={{ paddingVertical: 10, fontFamily: "Inter-Regular", }}>{index + 1}. {name}</Text>
                </TouchableOpacity>
            </View>
        )
    }
                    ...
                    <View style={{ flex: 1, paddingHorizontal: 10, marginTop: -10 }}>
                        ...
                        >
                            ...
                            <View style={{ flex: 1, justifyContent: 'center', marginLeft: 20 }}>
                                <Text style={{ fontSize: fontsize.medium, fontWeight: 'bold', fontFamily: "Inter-SemiBold", }}>{employeeName}</Text>
                                {/* <Text style={{ marginVertical: 5, color: colors.appTheme }}>{title}</Text>   */}
                                <Text style={{
                                    fontSize: fontsize.medium, color: colors.gray1, marginVertical: 5,
                                    fontFamily: "Inter-Regular",
                                    fontSize: 12,
                                    fontWeight: "normal",
                                    fontStyle: "normal",
                                    ...
                                    textAlign: "left",
                                    color: "#7d8895"
                                }}>{moment(dateCreate).format('HH:mm - DD [tháng] MM, YYYY')}</Text>
                                <View
                                    style={{
                                        marginRight: 10,
                                        marginVertical: 5,
                        ...
                        <View style={{ borderTopWidth: 0.5, borderTopColor: "#d4d4d4", margin: 10 }} />
                        {/* Properties */}
                        <View style={{
                            padding: 10,
                        }}>

                            <Text style={{ marginBottom: 0, fontWeight: 'bold', fontFamily: "Inter-SemiBold", }}>Thiết bị</Text>
                            <FlatList
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontWeight: 'bold', fontFamily: "Inter-SemiBold" }}>Lịch sử</Text>
                            {/* <FlatList
                                ItemSeparatorComponent={() => <View style={{ height: 10, backgroundColor: '#fff' }} />}
                                data={histories || []}
                                keyExtractor={(item, index) => `${index}`}
        ...
        return (
            <View style={styles.container}>
                <NavBar
                    ...
                    body={<Text style={{ color: '#fff', fontSize: fontsize.medium, fontWeight: 'bold', alignSelf: 'center', paddingLeft: 40, paddingRight: 40 }}>{data.description}</Text>}
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <View style={{ padding: 10, justifyContent: 'center', alignItems: 'center', backgroundColor: colors.appTheme, borderTopLeftRadius: 12, borderTopRightRadius: 12 }}>
                                    <Text style={{ color: 'white', fontWeight: 'bold', fontFamily: "Inter-SemiBold" }}>{action.name}</Text>
                                </View>
                                <View style={{ padding: 10 }}>
                                    <View style={{
                                        ...
                                        <Text style={{ color: colors.appTheme, fontFamily: "Inter-SemiBold" }}>Diễn giải</Text>
                                    </View>
                                    <TextInput
                                        maxLength={3000}
                                        underline={false}
...
export default connect(mapStateToProps, mapActionToProps)(ProposalDetailScreen);
