...
import { ActivityIndicator, RefreshControl, TextInput, Animated, Image, ImageBackground, Platform, StyleSheet, View, Text, ListView, FlatList, TouchableOpacity } from 'react-native';
            ...
            if (errorComponent) {
                ...
                return (
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Text style={{ fontSize: 48, marginTop: 20 }}>{Strings.app.error}</Text>
                    </View>
                );
            }
        ...
        if (emptyData) {
            if (emptyComponent) {
                ...
                return (
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <MyIcon name='layers' size={150} />
                        <Text style={{ fontSize: 48, marginTop: 20 }}>{Strings.app.emptyData}</Text>
                    </View>
                );
            }
        }
