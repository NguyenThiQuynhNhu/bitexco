...
const VendorInfo = (props) => {
    const { logo, towerName, statusId, contractName, departmentName, userActive, statusKey, userName, date } = props.data;
    return (
        <View
            style={{
                flex: 1,
        ...
        >
            ...
            <ImageProgress
                ...
                source={{ uri: logo }}
            />
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginLeft: 20, borderTopRightRadius: 20 }}>
                <View style={{ flex: 0.5, justifyContent: 'space-between', borderTopRightRadius: 20 }}>
                    <Text style={{
                ...
                <View style={{ flex: 0.5, justifyContent: 'space-between', borderTopRightRadius: 20 }}>
                    ...
                    <View style={{
                        ...
                        }}>{userActive ? `  ${userActive}` : `  ${Strings.createRequest.unreceived}`}</Text>
                    </View>
                </View>
            </View>
