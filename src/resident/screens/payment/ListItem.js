...
const FeildText = ({ style, name, text, nameStyle, textStyle }) => {
    return (
        <View style={{ marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', ...style }}>
            <Text style={{
    ...
    render() {
        ...
        return (
            <TouchableOpacity
                onPress={onPress}
                style={{
                    flexDirection: 'row', padding: 20, backgroundColor: '#fff', marginHorizontal: 20, marginVertical: 10,
                    borderRadius: 12,
                ...
                <View style={{ flex: 1 }}>
                    <View style={{ width: '95%', justifyContent: 'space-between' }}>
                        ...
                        <View style={{
                            ...
                            }}>{amountIncurred.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}</Text>
                            <Text style={{
                                fontFamily: "Inter-Regular",
                                fontSize: 11,
                                fontWeight: "normal",
                    ...
                    <FeildText name={Strings.payment.debt} text={amountLeft.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')} textStyle={{ fontWeight: 'bold' }} nameStyle={{}} />
                </View>
                <Text style={{
                    fontFamily: "Inter-Regular",
                    fontSize: 11,
