...
class PaymentHistoryScreen extends Component {
    ...
    renderContentTransInquiry() {
        ...
        if (errorTransInquiry && !errorTransInquiry.hasError) {
            return (
                <View>
                    <Text style={{ margin: 20, fontWeight: "bold", fontFamily: "Inter-Bold" }}>Kết quả truy vấn: {errorTransInquiry.message}</Text>
                </View>
            )
        }
    }
        ...
        return (
            <View style={{flex: 1, marginBottom: 20}}>
                <Text style={{
                    ...
                    marginHorizontal: 10,
                    fontStyle: 'italic',
                    color: 'red'}}>Lưu ý: Trong trường hợp thanh toán không thành công nhưng tài khoản của bạn vẫn bị trừ tiền, vui lòng thực hiện 'Truy vấn kết quả', nếu thanh toán ở cổng Viettel thành công liên hệ BQL để hoàn tiền. Liên hệ ban quản lý nếu có lỗi xảy ra!</Text>
                <FlatList
                    refreshing={isRefreshingEwallet}
                    onRefresh={() => this.props.refreshDataHandleEwalle()}
                    data={dataEwallet || []}
                        ...
                        <View style={{ backgroundColor: '#fff', marginHorizontal: 40, marginVertical: 100 }}>
                            <NavBar
                                body={<Text style={{
                                    ...
                                    textAlign: "center",
                                    color: "#ffffff"
                                }}>Kết quả truy vấn</Text>} rightView={null} />
                            {this.renderContentTransInquiry()}
                            <View style={{ flexDirection: 'row', margin: 10 }}>
                                <TouchableOpacity
                                    style={{
