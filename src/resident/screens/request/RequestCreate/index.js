...
class CreateScreen extends Component {
    ...
    render() {
        ...
        const {
            ...
            userContact,
            phoneContact,
            vendorSelected } = this.state

        return (
            <View>
                <NavBar
                    body={<View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}><Text style={{
                        ...
                        textAlign: "center",
                        color: "#ffffff"
                    }}>{Strings.createRequest.navTitle}</Text></View>}
                    leftButton={<TouchableOpacity onPress={() => this.props.navigation.goBack()} style={{ padding: 10 }}><MyIcon name="arrow" color="#fff" size={20} />
                    </TouchableOpacity>}
                    rightView={
                ...
                />
                <KeyboardAwareScrollView style={{ borderTopRightRadius: 20, marginTop: -20, paddingTop: 20 }}>
                    <View style={styles.container}>

                        <Lookup
                            visible={this.props.vendorDetail == null}
                            fielName={`${vendor} (*)`}
                            text={vendorSelected ? vendorSelected.name : Strings.createRequest.placeholderVendor} />
                        <View style={{
                        ...
                        <View style={{
                            ...
                            <Switch
                                style={{ flex: 0, paddingHorizontal: 0, paddingVertical: 0, color: '#6fcf97' }}
    ...
    async onNext() {
        ...
        const { time, day, title, content, phoneContact, userContact, vendorSelected, imagesInformation, isShowTime } = this.state;
        ...
        return this.props.createRequestHandle({
            ...
            userContact,
            phoneContact,
            imagesInformation: this.state.images.map(o => ({ mineType: o.type, bytes: o.data }))
        })
    }
}
