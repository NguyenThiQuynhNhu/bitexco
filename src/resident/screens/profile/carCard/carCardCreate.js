...
//
import { refreshDataHandle, createCarCardHandle } from '../../../actions/carCard';
class CarCardCreateScreen extends Component {
    ...
    async componentDidMount() {
        if(this.props.navigation.state.params){
            ...
            if(this.props.navigation.state.params.image && this.props.navigation.state.params.image.length>0){
                let ar=[]
    ...
    async onNext() {
        ...
        if (licencePlate == 0) {
            return this.refs.toast.show(`Vui lòng nhập biển số xe`, DURATION.LENGTH_LONG);
        }
        // if (carColor == 0) {
        ...
        // }
        if (typeID == null) {
            return this.refs.toast.show(`Vui lòng chọn loại xe`, DURATION.LENGTH_LONG);
        }
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                />
                <KeyboardAwareScrollView style={{ borderTopRightRadius: 20, paddingHorizontal: 20 }}>
                    <View style={styles.container}>
                        <View style={{
                            ...
                            <Text style={{
                                ...
                                fontSize: 16,
                                fontWeight: "bold",
                            }}>{Strings.carCard.carOwnerText} (*)</Text>
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                ...
                                fontSize: 16,
                                fontWeight: "bold",
                            }}>{Strings.carCard.licensePlateText} (*)</Text>
                            ...
                            <TextInput
                                ...
                                underlineColorAndroid='transparent'
                                onChangeText={(licencePlate) => { this.setState({ licencePlate }) }}
                            />
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                ...
                                fontSize: 16,
                                fontWeight: "bold",
                            }}>{Strings.carCard.carColorText}</Text>
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                ...
                                fontSize: 16,
                                fontWeight: "bold",
                            }}>{Strings.carCard.carModelText}</Text>
                            ...
                            <TextInput
                                ...
                                underlineColorAndroid='transparent'
                                onChangeText={(typeCarName) => { this.setState({ typeCarName }) }}
                            />

                        </View>
                        <Lookup
                            fielName={`${Strings.carCard.carTypeText} (*)`}
                            text={this.state.typeID ? this.state.typeName : Strings.carCard.placeholderType}
                            onPress={() => this.props.navigation.navigate('listTypeCar', { onSelected: (typeSelected) => this.setState({ typeID: typeSelected.typeID, typeName: typeSelected.typeName }) })}
                        />
                            ...
                            <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ marginTop: 20, }}>
                                {this.state.images.length < 5 && <View
                                    ...
                                    <View style={{
                                        ...
                                        >{Strings.createRequest.textPhoto}</Text>
                                    </View>
                                </View>}
                ...
                <Spinner visible={this.props.isLoading} color={colors.primaryKeyColor} />
...
export default connect(mapStateToProps, mapActionToProps)(CarCardCreateScreen);