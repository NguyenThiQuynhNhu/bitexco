...
class ChangePassScreen extends Component {
  ...
  async componentWillReceiveProps(nextProps) {
    ...
    if (!nextProps.isLoading && nextProps.content == 'CHANGEPASS_SUCCESS' && nextProps.content !== this.props.content) {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: '#fff' }}>
        <NavBar
          ...
          leftButton={this.props.user && this.props.user.isChangePass && <TouchableOpacity onPress={() => this.props.navigation.goBack()} style={{ padding: 10 }}><MyIcon name="arrow" color="#fff" size={20} /></TouchableOpacity>}
          body={<View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}><Text style={{
            ...
            textAlign: "center",
            color: "#ffffff"
          }}>{Strings.login.changePass}</Text></View>}
          rightView={
        ...
        >
          ...
          >
            <TextInput
              ...
              onChangeText={(passwordRetype) => this.setState({ passwordRetype: passwordRetype })}
          ...
          >
            <Text style={{
              ...
              textAlign: "center",
              color: "#ffffff"
            }}>{Strings.login.button1}</Text>
          </TouchableOpacity>
          {this.props.user && !this.props.user.isChangePass && <Text style={{color: 'red', fontStyle: 'italic', marginHorizontal: 20, marginVertical: 40}}>
            Đây là yêu cầu bắt buộc từ Ban quản lý tòa nhà. Vui lòng đổi mật khẩu để sử dụng các tiện ích khác!
          </Text>}
        </View>
