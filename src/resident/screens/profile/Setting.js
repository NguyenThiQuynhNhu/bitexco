...
class SettingScreen extends Component {
      ...
      <View style={styles.container}>
        <ScrollView >
          ...
          leftButton={<TouchableOpacity onPress={() => this.props.navigation.goBack()} style={{ padding: 10 }}><MyIcon name="arrow" color="#fff" size={20} /></TouchableOpacity>}
            body={<View style={{
              flex: 1, justifyContent: 'center', alignItems: 'center', fontFamily: "Inter-Bold",
              fontSize: 20,
              fontWeight: "bold",
              fontStyle: "normal",
              letterSpacing: 0,
              textAlign: "center",
              color: "#ffffff"
            }}><Text style={{ fontSize: FontSize.medium, color: '#fff' }}>{Strings.setting.language}</Text></View>}
          ...
          />
          <Text style={{
            marginLeft: 10, marginVertical: 10, fontFamily: "Inter-Bold",
            fontSize: 14,
            fontWeight: "bold",
            fontStyle: "normal",
            letterSpacing: 0,
  ...
  onLanguageValueChange = (value) => {
    this.props.resetStateByKey({ key: 'language', value: value == 0 ? 'vi' : 'en' })
