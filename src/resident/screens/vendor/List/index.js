...
import { loadDataHandle, refreshDataHandle, resetStateByKey } from '../../../actions/vendor'
...
class ListDataVendor extends Component {
    ...
    renderItem = ({ item, index }) => {
        return <ListItem item={item} onPress={() => this.props.canNavigate ? this.props.navigation.navigate('vendorDetail', item) : null} />
    }
    renderFooter = () => {
    ...
    render() {
        return (
            <View style={styles.container}>
                <View style={{ ...Device.defaultNavBarStyle(), backgroundColor: colors.appTheme }}>
                    <SearchBar
                ...
                <View>
                    ...
                    >
                        <ButtonFilter value={20} currentValue={this.state.type} onSelectedChange={this._onSelectedChange} />
                        <ButtonFilter value={10} currentValue={this.state.type} onSelectedChange={this._onSelectedChange} />
                        <ButtonFilter value={0} currentValue={this.state.type} onSelectedChange={this._onSelectedChange} />
                    </ScrollView>
                </View>
                {this.renderContent()}
            </View >)
...
export default connect(mapStateToProps, mapActionToState)(ListDataVendor);
