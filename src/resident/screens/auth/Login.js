...
import { getOtpCode, loginUser, changePhone, resetStateByKey, loginUserByPass, signIn } from '../../actions/auth';
...
class LoginScreen extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.error && this.props.error !== nextProps.error && nextProps.error.hasError) {
            let message = '';
    ...
    renderBody() {
        ...
        const { phoneNumber, otpCode, isPass, password, passwordRetype, isRegister } = this.state
        ...
        return (
            <KeyboardAwareScrollView >
                ...
                >
                    ...
                    {
                        content === "LOGIN" ? <Text style={{ marginBottom: 10 }}>© 2021 DIP Vietnam. All rights reserved.</Text> : null
                    }
                </View>
            </KeyboardAwareScrollView>
        );
