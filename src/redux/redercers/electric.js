...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case ELECTRIC_GETLIST_RESET_BY_KEY: {
        ...
        case ELECTRIC_GETLIST_REFRESHING: {
            return {
                ...state,
        ...
        case 'ELECTRIC_ON_SUBMIT_EDITING': {
            return {
                ...state,
            ...
            newData = newData.map((item) => {
                if (item.id === action.payload.data.id) {
                  return { ...item, 
                        ...
                        rateFeeLoss: action.payload.data.rateFeeLoss,
        ...
        case 'ELECTRIC_UPDATE_ITEM_TOLIST':
            let newData = state.data;
            newData = newData.map((item) => {
                if (item.id === action.payload.data.id) {
                    const data = {
