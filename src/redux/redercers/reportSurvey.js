...
export default (state = INITIAL_STATE, action) => {
    ...
    switch (action.type) {
        ...
        case 'SURVERY_REPORT_GETLIST_RESET_BY_KEY': {
        ...
        case 'SURVERY_REPORT_GETLIST_REQUEST': {
            return {
                ...state,
                isLoading: true,
        ...
        case 'SURVERY_REPORT_GETLIST_SUCCESS': {
        ...
        case 'SURVERY_REPORT_GETLIST_FAILURE': {
            return {
                ...state,
                initList: INITIAL_STATE.initList,
                isLoading: false,
        ...
        case 'SURVERY_REPORT_GETLIST_REFRESHING': {
            return {
                ...state,
                isRefreshing: true,
