...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case PROPOSAL_GETLIST_RESET_BY_KEY: {
        ...
        case PROPOSAL_GETLIST_REFRESHING: {
            return {
                ...state,
        ...
        case 'PROPOSAL_ON_SUBMIT_EDITING': {
            return {
                ...state,
        ...
        case 'PROPOSAL_UPDATE_ITEM_TOLIST':
