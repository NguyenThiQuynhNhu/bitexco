...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case SERVICES_EXTENSION_DETAIL_RESET_BY_KEY: {
        ...
        case SERVICES_EXTENSION_DETAIL_REQUEST: {
            return {
                ...state,
                initComponent: true,
                isLoading: true,
        ...
        case SERVICES_EXTENSION_DETAIL_SUCCESS: {
            return {
                ...state,
                initComponent: false,
                isLoading: false,
        ...
        case SERVICES_EXTENSION_DETAIL_FAILURE: {
            return {
                ...state,
                initComponent: false,
                isLoading: false,
        ...
        case SERVICES_EXTENSION_DETAIL_UPDATE_REQUEST: {
            return {
                ...state,
                isLoading: true,
        ...
        case SERVICES_EXTENSION_DETAIL_UPDATE_FAILURE: {
            return {
                ...state,
                isLoading: false,
        ...
        case SERVICES_EXTENSION_DETAIL_UPDATE_SUCCESS: {
            return {
                ...state,
                isLoading: false,
