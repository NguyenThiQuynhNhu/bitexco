...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case SHIFTCHANGE_GETLIST_RESET_BY_KEY: {
        ...
        case SHIFTCHANGE_GETLIST_REQUEST: {
            return {
                ...state,
                isLoading: true,
        ...
        case SHIFTCHANGE_GETLIST_SUCCESS: {
        ...
        case SHIFTCHANGE_GETLIST_FAILURE: {
            return {
                ...state,
                initList: INITIAL_STATE.initList,
                isLoading: false,
        ...
        case SHIFTCHANGE_GETLIST_REFRESHING: {
            return {
                ...state,
        ...
        case 'SHIFTCHANGE_ON_SUBMIT_EDITING': {
            return {
                ...state,
        ...
        case 'SHIFTCHANGE_ON_CLEAR_TEXT': {
        ...
        case 'SHIFTCHANGE_ON_CHANGE_TEXT': {
        ...
        case SHIFTCHANGE_CREATE_SUCCESS: {
            return {
                ...state,
        ...
        case SHIFTCHANGE_CLOSE_SUCCESS: {
            return {
                ...state,
                currentPage: INITIAL_STATE.currentPage,
                isRefreshing: true,
        ...
        case 'SHIFTCHANGE_UPDATE_ITEM_TOLIST':
