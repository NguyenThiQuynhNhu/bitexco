...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case CHECKLIST_CUSTOMER_TAISAN_GETLIST_RESET_BY_KEY: {
        ...
        case CHECKLIST_CUSTOMER_TAISAN_GETLIST_REQUEST: {
            return {
                ...state,
                isLoading: true,
        ...
        case CHECKLIST_CUSTOMER_TAISAN_GETLIST_SUCCESS: {
        ...
        case CHECKLIST_CUSTOMER_TAISAN_GETLIST_FAILURE: {
            return {
                ...state,
                initList: INITIAL_STATE.initList,
                isLoading: false,
        ...
        case CHECKLIST_CUSTOMER_TAISAN_GETLIST_REFRESHING: {
            return {
                ...state,
