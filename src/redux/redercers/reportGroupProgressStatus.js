...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case REPORT_GROUP_PROGRESS_STATUS_SET_PROPS: {
        ...
        case REPORT_GROUP_PROGRESS_STATUS_RERESHING: {
            return {
                ...state,
                isRefreshing: true,
        ...
        case REPORT_GROUP_PROGRESS_STATUS_REQUEST: {
            return {
                ...state,
                isLoading: true,
        ...
        case REPORT_GROUP_PROGRESS_STATUS_SUCCESS: {
            return {
                ...state,
        ...
        case REPORT_GROUP_PROGRESS_STATUS_FAILURE: {
            return {
                ...state,
                isRefreshing: INITIAL_STATE.isRefreshing,
                isLoading: INITIAL_STATE.isLoading,
