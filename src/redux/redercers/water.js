...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case WATER_GETLIST_RESET_BY_KEY: {
        ...
        case WATER_GETLIST_SUCCESS: {
            const newData = state.data.concat(action.payload.data);
            //console.log('newData', state.data.concat(action.payload.data))
            return {
                ...state,
