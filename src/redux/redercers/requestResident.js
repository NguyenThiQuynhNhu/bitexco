...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case R_REQUESTS_GETLIST_RESET_BY_KEY: {
        ...
        case R_REQUESTS_GETLIST_REQUEST: {
            return {
                ...state,
                isLoading: true,
        ...
        case R_REQUESTS_GETLIST_SUCCESS: {
        ...
        case R_REQUESTS_GETLIST_FAILURE: {
            return {
                ...state,
                initList: INITIAL_STATE.initList,
                isLoading: false,
        ...
        case R_REQUESTS_GETLIST_REFRESHING: {
            return {
                ...state,
        ...
        case 'R_REQUEST_ON_SUBMIT_EDITING': {
            return {
                ...state,
