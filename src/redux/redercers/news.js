...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case R_NEWS_GETLIST_RESET_BY_KEY: {
        ...
        case R_NEWS_GETLIST_REFRESHING: {
            return {
                ...state,
