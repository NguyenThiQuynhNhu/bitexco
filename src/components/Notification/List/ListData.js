        ...
        return <ListItem item={item} onPress={() => 
            {
                switch(item.typeId){
                    ...
                    break;
                    case 2:
                        navigation.navigate('newsDetail', { item: {id: item.linkIdNews, towerId: item.towerId, towerName: item.towerName}, type: 1 });
                    break;
                    case 3:
                    ...
                    case 4:
                        navigation.navigate('serviceExtensionDetail', { id: item.linkId })
                    break;
