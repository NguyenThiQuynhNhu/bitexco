                            ...
                            <View>
                                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
                                    <Text style={{
                                        ...
                                        textAlign: "left",
                                        color: "#626262"
                                    }} numberOfLines={1}>{Strings.electric.oldIndex}: <Text style={{
                                        ...
                                        textAlign: "left",
                                        color: "#ff3d00"
                                    }} numberOfLines={1}>{indexOld}</Text></Text>
                                    ...
                                    <Text style={{
                                        ...
                                        textAlign: "left",
                                        color: "#626262"
                                    }} numberOfLines={1}>{Strings.electric.newIndex}: <Text style={{
                                        marginVertical: responsive.h(5), fontFamily: "Inter-Medium",
                                        fontSize: responsive.h(12),
                                        fontWeight: "500",
                                        fontStyle: "normal",
                                        ...
                                        textAlign: "left",
                                        color: "#ff3d00"
                                    }} numberOfLines={1}>{indexNew}</Text></Text>
