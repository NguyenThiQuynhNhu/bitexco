...
import { resetStateByKey as resetAuth, loginUser, signOut } from '../actions/auth';
...
class Drawer extends Component {
    ...
    componentWillUpdate(nextProps) {
        ...
        if (nextProps.user && this.props.user && nextProps.user !== this.props.user) {
            this.props.getRequestStatusTotal({ towerId: nextProps.user !== null ? nextProps.user.towerId : -1 })
        }
    }
    renderMenuStatus(menus) {
        ...
        return (
            <View>
                <TouchableOpacity
                    style={{ paddingTop: 20, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Switch
                            ...
                            onValueChange={() => this.props.resetRequest({ key: 'isMine', path: '', value: !this.props.isMine })}
                        />
                    </View>
                ...
                <TouchableOpacity
                    onPress={() => {
                        ...
                        this.props.navigation.dispatch({ type: 'ON_STATUS_CHANGE', payload: 0 })
                ...
                >
                    <View style={{
                        borderRadius: 6,
                        backgroundColor: "#fff200", padding: 5, alignItems: 'center', justifyContent: 'center', marginRight: 10, marginLeft: 20
                    }}>
                        <MyIcon name={converStatusToIcon(0)} color='#fff' size={18} />
                    </View>
                        ...
                        return (
                            ...
                            >
                                <View style={{
                                    ...
                                    <MyIcon name={converStatusToIcon(id)} color='#fff' size={18} />
                                </View>
                                ...
                                >
                                    <Text style={{ fontSize: 10, margin: 2, color: '#fff' }}>{total}</Text>
                                </View>}
                    ...
                    return (
                        <TouchableOpacity
                            onPress={() => {
                                ...
                                switch (id) {
                                    case 0: break;
                                    case 1: return this.props.navigation.navigate('setting')
                                    case 2: {
                                    ...
                                    case 3: {
                                        ...
                                        break
                                    case 4: {
                                        return this.props.navigation.navigate('building', { phoneNumber: this.props.phoneNumber, password: this.props.password })
                                    }
                                    ...
                                    case 13: {
                                        return this.props.navigation.navigate('reportGroupsProgress')
                                    }
                                    case 14: {
    ...
    choiceVendor(item, user) {
        ...
        this.props.resetAuth({ key: 'user', path: '', value: { ...user, towerId: item.id, towerName: item.name, towerLogoUrl: item.logo } })
    }
                    ...
                    renderItem={({ item }) => {
                        ...
                        return (
                            <TouchableOpacity
                                ...
                                <View style={{
                                    backgroundColor: user.towerId == id ? 'rgba(255,255,255,0.4)' : 'transparent',
                                    justifyContent: 'center',
                                    alignItems: 'center',
                                    borderRadius: 30,
                                    width: 45,
                                ...
                                >
                                    <ImageProgress source={{ uri: logo }} circle={true} style={{ width: 40, height: 40 }} />
                                </View>
    ...
    render() {
        ...
        return (
            <View style={{ ...Device.defaultNavBarStyle(), flex: 1, backgroundColor: colors.appTheme }}>
                {/* header */}
                ...
                {user && <View style={{ flexDirection: 'row' }}>
                    ...
                    >
                        <ImageProgress source={{ uri: photoUrl }} circle={true} style={{ height: 50, width: 50 }} />

                    </TouchableOpacity>

                    <View style={{ flex: 1, justifyContent: 'center' }}>
                        <Text style={{
                            color: '#fff', ontFamily: "OpenSans-SemiBold",
                            fontSize: 20,
                            fontWeight: "600",
                        }}>{fullName}</Text>
                        <Text style={{
                ...
                {this.state.showListVendor ? this.renderVendorList(user) :
                    <View style={{ flex: 1, backgroundColor: '#fff', }}>
                        < View style={{ flexDirection: 'row', backgroundColor: "#fff200", paddingHorizontal: 10 }}>
                            {this.props.dataVendor.map((o, index) => {
                                if (index < 3) {
                                    return <TouchableOpacity
                                        key={index}
                                        onPress={() => this.props.resetAuth({ key: 'user', path: '', value: { ...user, towerId: o.id, towerName: o.name, towerLogoUrl: o.logo } })}
                                        style={{
                                            backgroundColor: user.towerId == o.id ? 'rgba(255,255,255,0.4)' : 'transparent',
                                            justifyContent: 'center',
                                            alignItems: 'center',
                                            borderRadius: 30,
                                            width: 45,
                                    ...
                                    >
                                        <ImageProgress source={{ uri: o.logo }} circle={true} style={{ height: 40, width: 40 }} />

                                    </TouchableOpacity>
                                }
                            })}
                            {this.props.dataVendor.length > 3 && <TouchableOpacity
                        ...
                        <ScrollView
                            ...
                            <TouchableOpacity
                                onPress={() => this.props.navigation.navigate('serviceExtension')}
                                style={{ paddingVertical: 20, paddingLeft: 20 }}>
                            ...
                            {this.renderMenu(this.props.typeList.length > 1 ? this.state.menuSetting : this.state.menuSetting1)}
                            ...
                            >
                                <Text style={{
                                    marginBottom: 10, fontFamily: "OpenSans-Regular",
                                    fontSize: 14,
                                    color: "#a0a0a0"
                                }}>Version 1.0 </Text>
                            </View>
                ...
                <ModalLogOut isShow={this.state.isShowModalLogout} onPress={() => this.setState({ isShowModalLogout: false })} />
                ...
                >
                    ...
                    {(this.props.error && this.props.error.hasError) ?
                        ...
                        >
                            {this.props.isLoadingChangeUser ? <View style={{ justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%', backgroundColor: '#fff' }}><ActivityIndicator /><Text>Đang tải</Text></View> :
                                <View style={{ flex: 1, marginTop: 70, alignItems: 'center' }}>
                                    <MyIcon
                                        ...
                                        color="#ffffff"
                                    />
                                    <Text style={{ fontSize: fontSize.medium, color: '#fff', marginTop: 20, margin: 20, justifyContent: 'center', alignItems: 'center', textAlign: 'center',fontWeight: 'bold' }}>Phiên đã hết hạn. Bạn có muốn đăng nhập lại?</Text>
                                    ...
                                    <View style={{ flexDirection: 'row', marginTop: 100 }}>
                                        ...
                                        <TouchableOpacity
                                            ...
                                            onPress={() => this.props.signOut({ towers: this.props.user.towers, tokenDevice: this.props.tokenDevice })}
                                        >
                                            <MyIcon
                                                name="check"
                                                size={30}
                            ...
                            {this.props.isLoadingChangeUser ? <View style={{ justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%', backgroundColor: '#fff' }}><ActivityIndicator /><Text>Đang tải</Text></View> :
                                <View style={{ flex: 1, marginTop: 70, alignItems: 'center' }}>
                                    <MyIcon
                                        ...
                                        color="#ffffff"
                                    />
                                    <Text style={{ fontSize: fontSize.medium, color: '#fff', marginTop: 20, margin: 20, justifyContent: 'center', alignItems: 'center', textAlign: 'center', fontWeight: 'bold' }}>{Strings.profile.questionChangeUser}</Text>
                                    ...
                                    <View style={{ flexDirection: 'row', marginTop: 100 }}>
                                        ...
                                        <TouchableOpacity
                                            ...
                                            onPress={() => this.props.loginUser({ phoneNumber: this.props.phoneNumber, type: 're', otpCode: this.props.otpCode, password: this.props.password })}
